...
EMAIL_PORT = 587
DEFAULT_FROM_EMAIL = 'no-reply@swivel.com.ng'

DJOSER = {
    'SEND_ACTIVATION_EMAIL': True,
    'PASSWORD_RESET_CONFIRM_URL': '#/password/reset/confirm/{uid}/{token}',
    'ACTIVATION_URL_VENDOR': os.getenv('EMAIL_ACTIVATION_URL_VENDOR'),
    'ACTIVATION_URL_CLIENT': os.getenv('EMAIL_ACTIVATION_URL_CLIENT'),
...
AUTH_CLIENT_MODEL = 'authentication.Client'
