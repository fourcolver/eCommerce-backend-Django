...
urlpatterns = [
    ...
    url(
        r'^users/jwt/create/?',
        views.VendorAuth.as_view(),
        name='jwt-create'),

    url(
        r'^clients/jwt/create/?',
        views.ClientAuth.as_view(),
        name='jwt-create'),
    url(
        r'^users/update/?$',
    ...
    url(
        r'^clients/activate/?$',
        views.ClientActivationView.as_view(),
        name='user-activate'
    ),
    url(
    ...
    url(
        r'prefer-location/entity/?$',
        views.PreferLocationUpdateView.as_view()
    ),
    url(
        r'prefer-location/update/?$',
        views.PreferLocationUpdateView.as_view()
    ),
